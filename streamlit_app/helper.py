...
with open('D:/django2/Waste-Classification-using-YOLOv8-main/streamlit-app/weights/best.pt', 'rb') as file:
...
def load_model(model_path):
    ...
    """
    model = YOLO('D:\django2\Waste-Classification-using-YOLOv8-main\streamlit-app\weights\yoloooo.pt')
    return model
